...
def make_grayscale(input_image):
    ...
    print('Image array of the entered image is: ' , image_array)
    
    decode_array_to_image = cv2.imdecode(image_array , cv2.IMREAD_UNCHANGED)
    print('Decoded values of the image in array format is: ' , decode_array_to_image)
    ...
    print('Status of the application: ' , status)
